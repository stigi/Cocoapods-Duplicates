...
#define COCOAPODS_POD_AVAILABLE_Expecta_ReactiveCocoa
#define COCOAPODS_VERSION_MAJOR_Expecta_ReactiveCocoa 0
#define COCOAPODS_VERSION_MINOR_Expecta_ReactiveCocoa 2
#define COCOAPODS_VERSION_PATCH_Expecta_ReactiveCocoa 0
